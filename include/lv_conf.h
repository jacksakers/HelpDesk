 ...
 *
 * Based on the official lv_conf_template.h for v9.2.3-dev.
 * Only features actually used by the project are enabled.
 */
...
/* Use LVGL's built-in implementations for malloc, string, sprintf */
...
#define LV_USE_DRAW_SW 1
    ...
    /* Selectively disable color format support to reduce code size. */
...
/*Enable matrix support — Requires `LV_USE_FLOAT = 1`*/
 ...
 *
 * All sizes enabled — your screens may use various sizes.
 * To save flash, disable sizes you don't use.
 */
...
/*Render test for each primitive. Requires at least 480x272 display*/
